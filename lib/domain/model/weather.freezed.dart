...
abstract class $WeatherCopyWith<$Res> {
  ...
  @useResult
  $Res call({String date, double tempmax, double tempmin, String icon});
}
...
class _$WeatherImpl extends _Weather {
  ...
  @override
  String toString() {
    return 'Weather(date: $date, tempmax: $tempmax, tempmin: $tempmin, icon: $icon)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, date, tempmax, tempmin, icon);
